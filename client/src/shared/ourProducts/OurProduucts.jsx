...
function OurProduucts() {
    return (
        ...
        <div>
            ...
            <div id='products' className="pt-[60px] container pb-15">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-6 p-0 sm:p-6">
                    {/* Card 1 */}
                    <div className="group hover:bg-pink-100 hover:border-[#2867B4] hover:border duration-700 bg-[#DCEBF8]  lg:w-2/5  max-w-md flex flex-col h-[300px]  md:h-[360px] lg:h-[350px] gap-5 p-5 py-16">
                    ...
                    {/* Card 2 */}
                    <div className="group hover:bg-pink-100 hover:border-[#2867B4] hover:border duration-700 bg-[#FFE6DD] h-[300px]  md:h-[360px] lg:w-1/3 lg:h-[350px] max-w-md flex flex-col gap-5 p-5 py-16">
